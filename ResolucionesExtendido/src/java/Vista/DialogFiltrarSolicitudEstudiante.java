...
public class DialogFiltrarSolicitudEstudiante extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtIDEstudiante.setToolTipText("Ingrese la identificación del estudiante");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txtIDEstudiante, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        idEstudiante = getTxtIDEstudiante().getText();
        if (!idEstudiante.isEmpty()){
            uibackoffice.ConsultarSolicitudesEstudiante(idEstudiante);
        }else{
            uibackoffice.showError("Ingresar el IDEstudiante antes de consultar");
        }
    ...
    public JTextField getTxtIDEstudiante() {
